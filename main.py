...
def run(sudoku_ui):
    ...
    while running:
                ...
                if pygame.mouse.get_pressed()[0]:
                    ...
                    if showing_menu:
                        ...
                        if sudoku_ui.new_game_clicked(mouse_cor):
                            ...
                            # Get selected cell
                            sudoku_ui.selected_cell = sudoku_ui.get_clicked_cell(mouse_cor)
                            ...
                            if sudoku_ui.highlighted_cell:
                                ...
                                if num_clicked:
                                    ...
                                    if sudoku_ui.grid[row][col] == 0 or isinstance(sudoku_ui.grid[row][col], str):
                                        sudoku_ui.handle_num_input(row, col, num_clicked)
        ...
        if showing_menu:
            sudoku_ui.game_menu()
        elif not sudoku_ui.freeze_screen:  # Prevents grid interaction at game end
